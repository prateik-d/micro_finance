...
<!-- Select2 -->
<script src="{{URL::to('/')}}/public/assets/plugins/select2/js/select2.full.min.js"></script>
<!-- daterangepicker -->
...
<!-- InputMask -->
<script src="{{URL::to('/')}}/public/assets/plugins/inputmask/min/jquery.inputmask.bundle.min.js"></script>
<!-- Bootstrap4 Duallistbox -->
<script src="{{URL::to('/')}}/public/assets/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
<!-- Bootstrap Switch -->
<script src="{{URL::to('/')}}/public/assets/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
<!-- bootstrap color picker -->
<script src="{{URL::to('/')}}/public/assets/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
