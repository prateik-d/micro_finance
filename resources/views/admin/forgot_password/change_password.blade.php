...
<html>
    <head>
        ...
        <!-- Font Awesome -->
        <link rel="stylesheet" href="{{URL::to('/')}}/public/assets/dist/css/style.css">
                ...
                <div class="card-body login-card-body">
                    ...
                    <form action="{{ url('/admin/change-password') }}" method="post">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" class="form-control" placeholder="******" name="npass" id="npass">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" class="form-control" placeholder="******" name="cnpass" id="cnpass">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                    <span class="fas fa-envelope"></span>
                                </div>
